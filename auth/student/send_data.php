            ...
            <div style="width:100%" id="right">
                <div   style="margin-bottom:20px;"  class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <center>
                            <a style="float: left;"href="index.php"> < ย้อนกลับ</a><br>
                            <?php echo "<h3>".$_SESSION['name']."</h3>";?>
                            <?php echo "<h4>ชั้น มัธยมศึกษาปีที่ : ".$_SESSION['class']."/".$_SESSION['room']."</h4>";?>
                            ...
                            <hr>
                            <?php
                            echo  "<h4>ชื่อชุมนุม : <span style='color:green'>".$club_name."</span>  รหัสชุมนุม : <span style='color:green'>".$row_club['club_id']."</span><br><br>ครูที่ปรึกษาชุมนุม : <span style='color:green'>"
                            .$row_club['club_tc']."</span> ห้องเรียน : <span style='color:green'>".$row_club['club_class']."</span>";
                            ?>
                            <form action="confirm.php"  method="post">
                                <br>
                                <input type="checkbox" required/> : <span style="color:red;">กรุณาคลิกถูกเพื่อทำการเลือกชุมนุมนี้</span>
                                <input type="hidden" value="<?php echo $id?>" name="club_hid">
                                <br><input style="width:40%;"type="submit" id="submit" value="ยืนยัน" name="confirm">
                            </form>
                        </center>
                    </div>
                    <!---->
